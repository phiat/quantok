defmodule Quantok.Node.Passive do
  ...
  Config:
  - :shape - :floor | :wall | :ramp | :funnel | :attractor | :repeller
  ...
  @type shape :: :floor | :wall | :ramp | :funnel | :attractor | :repeller
  ...
  def new(shape, opts \\ []) do
    config = %{
      ...
      friction: Keyword.get(opts, :friction, 0.5),
  ...
  def solid?(%Node{config: %{shape: shape}}) when shape in [:floor, :wall, :ramp, :funnel],
    do: true
